<template>
    <GuestLayout title="Infrastruktur Desa">
        <!-- Hero Section -->
        <div class="bg-gradient-to-r from-red-600 to-red-800 text-white py-16 md:py-24">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto text-center">
                    <h1 class="text-3xl md:text-4xl font-bold mb-4">Infrastruktur</h1>
                    <p class="text-xl text-red-100 opacity-90">
                        Fasilitas dan infrastruktur yang tersedia di Desa Kumantan
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-else class="text-center py-12 bg-white rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">
                        Data infrastruktur sedang dalam proses pengumpulan.
                    </p>
                </div>
            </div>
        </section>
