<template>
    <AdminLayout title="Edit Data Penduduk">
        <FormCard title="Edit Data Penduduk" :cancel-route="route('admin.residents.index')" submit-text="Update Data"
...
const form = useForm({
    ...
    family_card_number: props.resident.family_card_number || '',
    full_name: props.resident.full_name || '',
    address: props.resident.address || '',
    rt: props.resident.rt || '',
    rw: props.resident.rw || '',
    hamlet: props.resident.hamlet || '',
    ...
    last_education: props.resident.last_education || '',
    blood_type: props.resident.blood_type || '',
    citizenship: props.resident.citizenship || 'wni',
    life_status: props.resident.life_status || 'alive',
    mother_name: props.resident.mother_name || '',
    father_name: props.resident.father_name || '',
    family_relationship_status: props.resident.family_relationship_status || '',
...
const submit = () => {
    form.post(route('admin.residents.update', props.resident.id));
};
</script>
